...
import {IMintCallback, IPool} from "../interfaces/IPool.sol";
...
contract TestLP is IMintCallback {
    ...
    function collect(
        ...
        (,,, uint128 tokensOwed0, uint128 tokensOwed1) = IPool(pool).getPosition(address(this));
        (amount0, amount1) = IPool(pool).collect(recipient, tokensOwed0, tokensOwed1);
    }
